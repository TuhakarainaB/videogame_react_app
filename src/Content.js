    ...
    return(
        ...
        <div className="row">
            <div className="card col me-3 shadow">
                <img className="card-img-top" src="images/borderlands3.jpeg" alt="Borderlands" />
                <div className="card-body">
                    <h5 className="card-title">Borderlands 3</h5>
            ...
            <div className="card col me-3 shadow">
                <img className="card-img-top" src="images/octopath.jpeg" alt="OCTOPATH TRAVELER" />
                <div className="card-body">
                    <h5 className="card-title">OCTOPATH TRAVELER</h5>
                    <p className="card-text">
            ...
            <div className="card col me-3 shadow">
                <img className="card-img-top" src="images/reddead2.jpeg" alt="Red Dead Redemption 2" />
                <div className="card-body">
